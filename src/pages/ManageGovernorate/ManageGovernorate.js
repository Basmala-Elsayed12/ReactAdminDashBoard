...
//       .catch((err) => {
//         console.log(err);
//         setgovern({ ...govern, loading: false, err: "something went wrong" });
//       });
...
//           reload: govern.reload + 1,
//         });
//         console.log(resp.data.token);
//       })
//       .catch((err) => {
//         console.log(err);
//         setgovern({ ...govern, loading: false, err: "could not delete it" });
//       });
//   };

//   console.log(govern.results);
//   return (
//     <div className="p-5">
//       <div className="table-header d-flex justify-content-between mb-3">
//         <h2> ManageGovernorate</h2>
//         <Link
//           to={"/manage-govern/add"}
...
//         </thead>
//         <tbody>
//           {govern.results.map((governs) => (
//             <tr key={governs._id}>
//               <td>{governs._id}</td>
//               <td>
//                 <img className="table-img" src={governs.image} alt="" />
//               </td>
//               <td>{governs.name}</td>

//               <td>
//                 <div>
//                   <Link to={governs._id} className="btn btn-light mx-3 btn-lg">
//                     Update
//                   </Link>
//                   {/* <button
//                     className="btn btn-danger mx-3 btn-lg"
//                     onClick={() => {
//                       deletegovern(governs._id);
//                     }}
//                   >
//                     Delete
//                   </button> */}
...
//                       deletegovern(governs._id);
//                     }}
//                     disabled={governs.loading}
//                   >
//                     {governs.loading ? "Deleting..." : "Delete"}
//                   </Button>
//                 </div>
//               </td>
//             </tr>
